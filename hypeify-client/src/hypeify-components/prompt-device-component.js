...
import {Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Paper, Grid, Icon} from "@material-ui/core"
                    ...
                    <div key={i}>
                        <Grid item xs={12}>
                            <Paper style={{textAlign: "center"}}>
                                <DialogContentText>{this.state.deviceInfo.deviceInfo[i].name} </DialogContentText>
                                <Button onClick= {() => { this.selectDevice(i) }}>
                                    {selectedDeviceIcon}
                                </Button>
                                <DialogContentText>{this.state.deviceInfo.deviceInfo[i].type} </DialogContentText>
                            </Paper>
                        </Grid>
                    </div>
                    );
