...
module.exports.getSpotifyDevices = async function getSpotifyDevices(activeUser) {
...
module.exports.pauseCurrentTrack = async function pauseCurrentTrack(activeUser) {
...
module.exports.resumeCurrentTrack = async function resumeCurrentTrack(activeUser) {
...
module.exports.skipCurrentTrack = async function skipCurrentTrack(isSkipForward, activeUser) {
...
module.exports.getPlaylistTracks = async function getPlaylistTracks(playlistTrackID, activeUser) {
